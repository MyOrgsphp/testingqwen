...
$videos = array();
if (is_array($liked_videos) && !empty($liked_videos)) {
    $args = array(
        'post_type' => 'video',
        'posts_per_page' => -1,
        'post_status' => 'publish',
...
<div class="liked-videos-page">
    <h2><?php _e('Liked Videos', 'wp-tube'); ?></h2>
    ...
    <?php else : ?>
        <p><?php _e('No liked videos yet. Like videos you enjoy!', 'wp-tube'); ?></p>
    <?php endif; ?>
</div>
